...
class BinarySearchTree:
    ...
    def height(self) -> int:
        ...
        if self.is_empty():
            ...
            re_var = 1
            re_var += max(self._left.height(), self._right.height())
            return re_var
    ...
    def items_in_range(self, start: Any, end: Any) -> List:
        ...
        if self.is_empty():
            ...
            re_var.extend(self._left.items_in_range(start, end))
            re_var.append(self._root)
            re_var.extend(self._right.items_in_range(start, end))
            return re_var
        elif end < self._root:
            re_var.extend(self._left.items_in_range(start, end))
            return re_var
    ...
    def rotate_right(self) -> None:
        ...
        <BLANKLINE>
        """
        left = self._left._left
        right = BinarySearchTree(self._root)
        right._left = self._left._right
        right._right = self._right
    ...
    def rotate_left(self) -> None:
        ...
        <BLANKLINE>
        """
        right = self._right._right
        left = BinarySearchTree(self._root)
